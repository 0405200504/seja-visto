        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Reveal delay={100}>
            <BentoCard
              ...
              text="São 8 módulos e 38 aulas em texto, organizadas para você aprender no seu ritmo e consultar sempre que precisar."
            >
              <div className="mt-5 space-y-2">
                {["Boas Vindas", "Fundamentos", "Armário Essencial"].map(
                  (mod, i) => (
                    <div
                      key={mod}
