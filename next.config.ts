...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    // 55 = miniaturas das esteiras (imagem em movimento, ninguém repara);
    // 70 = fotos da página de vendas; 80 = seção do Raphael; 75 = padrão do app.
    qualities: [55, 70, 75, 80],
    // 448 é o tamanho exato dos cards das esteiras em tela 2x (224px). Sem ele
    // o menor degrau disponível era 640px — quase o dobro de bytes à toa.
